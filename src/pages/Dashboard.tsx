...
//   const showSuccessMessage = (message: string, setter: (msg: string) => void, timeoutRef: React.MutableRefObject<number | null>) => {
//     setter(message);
...
//       // Update results with the edited note
//       if (results && results.results) {
//         const updatedResults = {
//           ...results,
...
const Dashboard: React.FC = () => {
  ...
  // ✅ useRef with number | null — works in browser
